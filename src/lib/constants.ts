import type { Permission } from "@/features/commands/PermissionBadge";
...
import { ROUTE_ACCESS, CURRENT_ROLE, isRouteVisible } from "@/config/accessConfig";

const LEGAL_ROUTES = ["/privacy-policy", "/terms-of-use", "/sales-and-refunds"] as const;

export const KNOWN_ROUTES: readonly string[] = [
  ...ROUTE_ACCESS.filter((r) => isRouteVisible(r, CURRENT_ROLE)).map((r) => r.path),
  ...LEGAL_ROUTES,
];
