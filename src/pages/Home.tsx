...
const FEATURES: Feature[] = [
  {
    ...
    title: "The Laypeople",
    description:
      "The community. The people that make this whole thing actually fun. Come hang out with The Laypeople.",
    icon: Users,
    path: "/laypeople",
  ...
  },
  {
    ...
    title: "The Streams",
    description:
      "Schedule, rules, setup, emotes, and where to watch. Everything you need to know about The Layman's streams.",
    icon: Tv,
    path: "/streams",
    gradient: "from-purple-500/20 to-violet-500/20",
  },
  {
    ...
    title: "The Content",
    description:
      "Socials, announcements, and milestones. Everything happening across every platform in one place.",
    icon: Layers,
    path: "/content",
  ...
  },
  {
    ...
    title: "The Commands",
    description:
      "All the chat commands you need to interact with the stream. From fun to functional.",
    icon: Terminal,
    path: "/commands",
    ...
    <ScrollRevealSection delay={0.1 + index * 0.1}>
      ...
      >
        <div className="flex-shrink-0">
          ...
          >
            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 3xl:w-20 3xl:h-20 4xl:w-24 4xl:h-24 5xl:w-28 5xl:h-28 text-white/80">
              {icon}
            </div>
          </div>
        </div>
        ...
        >
          <h3 className="text-xl sm:text-2xl lg:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl font-bold mb-2 sm:mb-3">
            {name}
          </h3>
          <p
    ...
    <ScrollRevealSection delay={0.1 + index * 0.1}>
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground text-base lg:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-4 sm:mb-6 max-w-md 3xl:max-w-lg 4xl:max-w-xl 5xl:max-w-2xl">
            {description}
          </p>
          <Link
            to={path}
    ...
    <PageWrapper>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="absolute inset-0 bg-accent/20 rounded-full blur-3xl scale-150"
              aria-hidden="true"
            />
            <div
              className="absolute inset-0 bg-primary/40 rounded-full blur-2xl scale-125"
              aria-hidden="true"
            />
        ...
        <div className="max-w-6xl 3xl:max-w-7xl 4xl:max-w-[100rem] 5xl:max-w-[120rem] mx-auto space-y-16 lg:space-y-20 4xl:space-y-24">
          {isSectionVisible("home.about") && (
            <div className="text-center">
              <ScrollRevealSection>
                <h2 className="text-3xl sm:text-4xl lg:text-6xl 3xl:text-7xl 4xl:text-8xl 5xl:text-9xl font-bold tracking-tight mb-4 sm:mb-6">
                  YELLOW, LAYPEOPLE!
                </h2>
              </ScrollRevealSection>
              ...
              <ScrollRevealSection delay={0.1}>
                <p className="text-lg sm:text-xl lg:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl text-muted-foreground leading-relaxed mb-4 sm:mb-6 font-light max-w-3xl 3xl:max-w-4xl 4xl:max-w-5xl 5xl:max-w-6xl mx-auto">
                  I'm LaymanLouie, but I always introduce myself and, NORMALLY,
                  go by "Layman" or "THE Layman". I'm here to create a space
                  full of fun moments, good laughs, and a community you can feel
                  comfortable in.
                </p>
              </ScrollRevealSection>
              ...
              <ScrollRevealSection delay={0.2}>
                <p className="text-base sm:text-lg lg:text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl text-muted-foreground leading-relaxed mb-6 sm:mb-8 max-w-3xl 3xl:max-w-4xl mx-auto">
                  Whether we're gaming, talking, or just hanging out, the goal
                  is always the same:
                </p>
              </ScrollRevealSection>
