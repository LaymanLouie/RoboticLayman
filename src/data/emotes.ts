...
export const EMOTE_PLATFORMS: EmotePlatformMeta[] = [
  {
    ...
    label: "Twitch",
    brandColor: "#9146FF",
    description: "Twitch Subscriber Emotes",
  },
  {
    key: "7tv",
    label: "7TV",
    brandColor: "#29D398",
    description: "7TV Custom Emotes",
  },
  {
    key: "bttv",
    label: "BTTV",
    brandColor: "#D50014",
    description: "BetterTTV Custom Emotes",
  },
  {
    key: "ffz",
    label: "FFZ",
    brandColor: "#5C99D4",
    description: "FrankerFaceZ Custom Emotes",
  },
];

export const EMOTES: Emote[] = [
  {
    code: "FrancineTHISISFINE",
    platform: "twitch",
    src: francineThisIsFine,
    animated: false,
    tier: "tier1",
    setName: "Francine",
  },
  ...
  {
    code: "FrancineFACEPALM",
    platform: "twitch",
    src: francineFacepalm,
    animated: false,
    tier: "tier1",
    setName: "Francine",
  },
