  ...
  return (
    <PageWrapper>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-3xl 3xl:max-w-5xl 4xl:max-w-6xl 5xl:max-w-7xl mx-auto space-y-10 3xl:space-y-14 text-muted-foreground 3xl:text-lg 4xl:text-xl leading-relaxed">
          {children}
        </div>
      </section>
    </PageWrapper>
