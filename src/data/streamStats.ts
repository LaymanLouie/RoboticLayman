...
export function getStreamStats(): StreamStats {
  ...
  return {
    ...
    totals: {
      ...
      minutesStreamed:
        totals.minutesStreamed || STREAM_STATS.totals.minutesStreamed,
      minutesWatched:
        totals.minutesWatched || STREAM_STATS.totals.minutesWatched,
    ...
    records: {
      ...
      mostUniqueViewers: totals.mostUniqueViewersDate
        ? {
            value: totals.mostUniqueViewers,
            date: totals.mostUniqueViewersDate,
          }
      ...
      highestAverageViewers: totals.highestAverageViewersDate
        ? {
            value: Math.round(totals.highestAverageViewers),
            date: totals.highestAverageViewersDate,
          }
