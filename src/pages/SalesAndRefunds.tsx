  ...
  return (
    <DocumentPageLayout title="Sales & Refunds" lastUpdated={LAST_UPDATED}>
      <DocumentSection delay={0}>
        <DocumentText>
          This Sales and Refund Policy explains what happens if you purchase
          something through {SITE_NAME} and need help with a refund.
        </DocumentText>
        <DocumentText emphasis>
          By making a purchase, you agree to this policy, along with our Terms
      ...
      <DocumentSection title="Who We Are" delay={0.05}>
        ...
        <DocumentText>
          References to "we," "us," or "our" in this policy refer collectively
      ...
      <DocumentSection title="Current Status" delay={0.15}>
        <DocumentText emphasis>
          {SITE_NAME} does not currently sell anything. Merch is offline, there
          are no paid digital features, and there is no checkout flow on the
          site today.
        </DocumentText>
        <DocumentText>
          The rest of this policy applies once any of those things change. If
          something does go on sale (merch, digital extras, subscriptions), the
          terms below will be how we handle it.
        </DocumentText>
      </DocumentSection>

      <DocumentSection title="What We May Sell in the Future" delay={0.2}>
        <DocumentText>
          If purchases are introduced, they may include:
        </DocumentText>
        <DocumentList>
        ...
        <DocumentText>
          <span className="text-foreground font-medium">Note:</span> Virtual
          chips, points, and similar in-app currencies have no real-world cash
          value and are not redeemable for cash.
        </DocumentText>
      </DocumentSection>

      <DocumentSection title="Digital Purchases and Refunds" delay={0.25}>
        <DocumentText>
          Because digital products are delivered instantly, refunds can be
          limited. We try to be reasonable.
        </DocumentText>
        ...
        <DocumentSubsection title="Refunds We Typically Approve">
          <DocumentList>
            ...
            <li>
              Purchases you could not use due to a Service-side technical issue
            </li>
          </DocumentList>
        </DocumentSubsection>
        ...
        <DocumentSubsection title="Refunds We Typically Do Not Approve">
          <DocumentList>
            ...
            <li>
              Issues caused by third-party platforms (such as Twitch or Discord
              outages or API changes)
            </li>
      ...
      <DocumentSection title="Physical Merch (When Available)" delay={0.3}>
        <DocumentText>
          If we offer physical merch in the future, refunds and returns will be
          handled by the merch fulfillment partner we use at the time, under
      ...
      <DocumentSection title="App Store Purchases" delay={0.35}>
        <DocumentText>
          If you ever purchase through the Apple App Store, Google Play, or
          another platform store, refunds are handled by that platform's own
          process.
        </DocumentText>
        <DocumentText>
          We can still help you troubleshoot, but we cannot override another
          platform's refund decisions.
        </DocumentText>
      </DocumentSection>
      ...
      <DocumentSection title="Subscriptions" delay={0.4}>
        ...
        <DocumentList>
          <li>
            You can cancel at any time through the platform you subscribed on
          </li>
          ...
          <li>
            Refunds for partial subscription periods are generally not provided
      ...
      <DocumentSection title="Price Changes and Promotions" delay={0.45}>
        <DocumentText>
          We may change pricing or run promotions at any time. Unless required
          by law, we do not provide refunds for price drops or limited-time
          deals after your purchase.
        </DocumentText>
      </DocumentSection>
      ...
      <DocumentSection title="Chargebacks and Abuse" delay={0.5}>
        ...
        <DocumentText emphasis>
          If something went wrong, please reach out first. We're humans over
          here.
        </DocumentText>
      </DocumentSection>
      ...
      <DocumentSection title="How to Request a Refund" delay={0.55}>
        ...
        <DocumentText>
          Requests are handled through the Discord for {SITE_NAME} or our
      ...
      <DocumentSection title="Contact" delay={0.65}>
        <DocumentText>
          If you have questions or concerns about purchases, refunds, or
          billing, reach out through our social channels or the Discord for{" "}
          {SITE_NAME}.
        </DocumentText>
        <DocumentText>
