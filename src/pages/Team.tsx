      ...
      >
        <div className="flex-shrink-0 relative">
          ...
          {accent.intense && (
            <div
              ...
              style={{
                background: `radial-gradient(circle, ${accent.glowInner}, transparent 65%)`,
              }}
              aria-hidden="true"
            />
          )}
        ...
        >
          ...
          >
            <span
              className={cn(
                "font-mono text-sm 3xl:text-base tracking-widest",
                accent.number,
              )}
            >
              {numberLabel}
            ...
            <span
              className={cn(
                "text-xs 3xl:text-sm uppercase tracking-[0.3em] font-semibold",
                accent.role,
              )}
            >
              {getRoleLabel(member)}
    ...
    <PageWrapper>
      <section className="pt-24 pb-12 px-6">
        <div className="container mx-auto text-center">
          ...
          >
            {preventOrphan(
              `The Layman and the people keeping chat alive. Meet ${composeModTeam()}.`,
            )}
          </motion.p>
        </div>
      </section>
          ...
          <div>
            ...
            <ScrollRevealSection delay={0.1}>
              <p className="text-lg sm:text-xl lg:text-2xl 3xl:text-3xl text-muted-foreground text-center mb-12 lg:mb-16 font-light max-w-2xl 3xl:max-w-3xl mx-auto">
                {preventOrphan("The people keeping everything in check.")}
              </p>
            </ScrollRevealSection>
