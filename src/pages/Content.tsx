      ...
      {isSectionVisible("content.socials") && (
        <section className="py-32 px-6">
          <div className="max-w-6xl 3xl:max-w-7xl 4xl:max-w-[100rem] 5xl:max-w-[120rem] mx-auto">
            <SectionHeading
              title="Socials"
              subtitle="All the places you can find me."
            />
                    ...
                    >
                      ...
                      <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-300 w-full">
                        <div className="overflow-hidden">
                          <span className="relative flex items-center justify-center gap-1 pt-1 pb-2 3xl:pb-3 text-sm 3xl:text-base 4xl:text-lg font-semibold whitespace-nowrap text-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 delay-100">
                            {social.displayName}
                ...
                return (
                  ...
                  >
                    <article className="h-full flex flex-col gap-2 p-4 rounded-xl border border-primary/20 bg-gradient-to-br from-primary/8 via-card/40 to-transparent shadow-md shadow-primary/5">
                      ...
                      <p className="text-[13px] text-muted-foreground leading-relaxed flex-1 line-clamp-2">
                      ...
                      <div className="pt-3 border-t border-border/15 flex items-center gap-2">
                        ...
                        {Number.isFinite(
                          parseProjectDateTime(milestone.date).getTime(),
                        ) ? (
                          <DateTime
                            date={milestone.date}
                            isProjectFormat
