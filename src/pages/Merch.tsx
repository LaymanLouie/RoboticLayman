        ...
        <section className="flex-1 flex items-center justify-center px-6 pb-24">
          <div className="max-w-2xl 3xl:max-w-3xl 4xl:max-w-4xl mx-auto text-center">
            ...
            <ScrollRevealSection delay={0.1}>
              <h2 className="text-3xl md:text-4xl 3xl:text-5xl 4xl:text-6xl font-bold mb-4">
                Coming Soon
              </h2>
            </ScrollRevealSection>
            ...
            <ScrollRevealSection delay={0.2}>
              <p className="text-lg 3xl:text-xl 4xl:text-2xl text-muted-foreground mb-8">
                We're cooking up something special. Clothes, accessories, and
                more, all designed by the Layman Legion.
              </p>
            </ScrollRevealSection>
