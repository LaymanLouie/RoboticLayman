...
export const SOCIALS: Record<SocialPlatformKey, SocialEntry> = {
  ...
  tiktok: {
    ...
    brandColor: "#00F2EA",
    hoverBg:
      "linear-gradient(135deg, rgba(0,242,234,0.8) 0%, rgba(255,0,80,0.8) 100%)",
  },
  instagram: {
    platform: "instagram",
    handle: "@laymanlouie",
  ...
  threads: {
    platform: "threads",
    handle: "@laymanlouie",
    url: "https://www.threads.com/@laymanlouie",
    displayName: "Threads",
    brandColor: "#FFFFFF",
    hoverBg: "rgba(255, 255, 255, 0.2)",
  },
  ...
  spotify: {
    platform: "spotify",
    handle: "LaymanLouie",
    url: "https://open.spotify.com/user/313mw3tjkpzzc5vtrdjjetvu4asy",
    displayName: "Spotify",
    brandColor: "#1DB954",
  ...
  linkedin: {
    platform: "linkedin",
    handle: "laymanlouie",
    url: "https://www.linkedin.com/in/layman-louie-1b8774408/",
