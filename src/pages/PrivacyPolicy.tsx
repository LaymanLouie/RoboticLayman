  ...
  return (
    <DocumentPageLayout title="Privacy Policy" lastUpdated={LAST_UPDATED}>
      <DocumentSection delay={0}>
        <DocumentText>
          This Privacy Policy explains how {SITE_NAME} handles information when
          you visit the site or interact with the {COMMUNITY_PLURAL} across our
          connected platforms.
        </DocumentText>
        <DocumentText emphasis>
          Short version: we keep almost nothing, we don't sell anything, and we
          try to be transparent about what little we do touch.
        </DocumentText>
      </DocumentSection>
      ...
      <DocumentSection title="Who We Are" delay={0.05}>
        ...
        <DocumentText>
          References to "we," "us," or "our" in this Privacy Policy refer
          collectively to the operator and moderators of {SITE_NAME}.
        </DocumentText>
        <DocumentText>
      ...
      <DocumentSection title="How the Site Currently Works" delay={0.15}>
        <DocumentText>
          As of today, {SITE_NAME} is a static, file-based site. There is no
          live database, no analytics service, no tracking pixels, and no
          advertising.
        </DocumentText>
        <DocumentList>
          <li>The site renders entirely in your browser</li>
          <li>
            Content like games, quotes, commands, and milestones is shipped as
            part of the site itself
          </li>
          <li>
            Aggregated leaderboards (watch hours, chips) are derived from the
            streamer's own Twitch and chat-bot exports before deploy, never from
            anything you do on the site
          </li>
        </DocumentList>
      </DocumentSection>
      ...
      <DocumentSection title="Information We Collect" delay={0.2}>
        <DocumentText>
          Right now, very little. Here's the full picture.
        </DocumentText>

        <DocumentSubsection title="Sign-In (Planned)">
          <DocumentText>
            Account features will use Twitch as your primary identity, with
            Discord as an optional secondary link, both via OAuth. When that
            ships, we may receive:
          </DocumentText>
          <DocumentList>
          ...
          <DocumentText emphasis>
            We never receive your Twitch or Discord password.
          </DocumentText>
        </DocumentSubsection>

        <DocumentSubsection title="Browser Storage">
          <DocumentText>
            We use your browser's local storage only for UI preferences (such as
            remembering minor display choices). No personal data is stored
            there.
          </DocumentText>
        </DocumentSubsection>
        ...
        <DocumentSubsection title="Viewer Economy Data">
          <DocumentText>
            Public leaderboards show top {COMMUNITY_PLURAL} by watch time and
            chips. Those numbers come from the streamer's own chat-bot exports,
            are aggregated before publishing, and only display username and
            totals.
          </DocumentText>
          <DocumentList>
            ...
            <li>
              Bots and viewers who have unfollowed can be hidden from public
              surfaces while their underlying records are kept private
            </li>
          </DocumentList>
        </DocumentSubsection>
        ...
        <DocumentSubsection title="Communications">
          <DocumentText>
            If you reach out through Discord or our social channels, we may keep
            your message and contact info only long enough to respond.
          </DocumentText>
        </DocumentSubsection>
      </DocumentSection>
      ...
      <DocumentSection title="Sharing Your Information" delay={0.35}>
        ...
        <DocumentList>
          ...
          <li>
            With trusted infrastructure providers that host or secure the site
          </li>
      ...
      <DocumentSection title="Third-Party Services" delay={0.4}>
        <DocumentText>
          {SITE_NAME} links to or integrates with third-party services such as
          Twitch, YouTube, Discord, TikTok, Spotify, and others. These services
          have their own privacy policies. We are not responsible for how they
          handle your data.
        </DocumentText>
      </DocumentSection>
      ...
      <DocumentSection title="Data Security" delay={0.45}>
        <DocumentText>
          We take reasonable steps to protect any data we hold:
        </DocumentText>
        <DocumentList>
          <li>Industry-standard hosting and transport security</li>
          <li>Restricted access to anything sensitive</li>
          <li>
            Minimal collection so there is less to protect in the first place
          </li>
        </DocumentList>
        <DocumentText>
          No system is 100% perfect. If a breach affects your information, we
      ...
      <DocumentSection title="Your Privacy Rights" delay={0.5}>
        ...
        <DocumentText>
          Once accounts ship, you'll be able to request that {STREAMER_LABEL}{" "}
          hide your viewer record from public surfaces or fully delete it. Until
          then, reach out through our channels for help.
        </DocumentText>
      </DocumentSection>

      <DocumentSection title="Children's Privacy" delay={0.55}>
        <DocumentText>
          {SITE_NAME} is not intended for users under 13. We do not knowingly
      ...
      <DocumentSection title="Contact" delay={0.6}>
        <DocumentText>
          If you have questions or concerns about privacy, reach out through our
          social channels or the Discord for {SITE_NAME}.
        </DocumentText>
        <DocumentText>
