...
export const commands: Command[] = [
  ...
  },
  {
    ...
    description:
      "This command allows the Laypeople to add something... funny that The Layman said. Heheh.",
  },
  {
    id: 6,
    name: "!advice",
  ...
  },
  {
    ...
    description:
      "This command tells you how long The Layman has been getting chased.",
  },
  {
    id: 19,
    name: "!checkuser",
  ...
  },
  {
    ...
    commandGroups: ["Fun", "Utility"],
    description:
      "This command says how long The Layman was chased OR ACTUALLY ESCAPED!",
  },
  {
    id: 35,
    name: "!endstopwatch",
  ...
  },
  {
    ...
    description:
      "This command tells you how to make that pie you were thinking about earlier.",
  },
  {
    id: 82,
    name: "!pin",
    ...
    commandGroups: ["Avatars"],
    description:
      "This command pins an avatar in place. Username defaults to you, and x and y default to random spots from 0 to 1.",
    parameterGroups: [
      {
        usage: "[username]",
        description:
          "These options pin yourself or someone else at a random spot.",
      },
      {
        usage: "[username] [x] [y]",
        description:
          "These options pin yourself or someone else at specific coordinates from 0 to 1.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    commandGroups: ["Layman", "Lore", "Fun"],
    description:
      "This command tells us all a random quote that The Layman has said.",
    parameterGroups: [
      {
        usage: "[number]",
        description:
  ...
  },
  {
    ...
    commandGroups: ["Layman", "Lore", "Fun"],
    description:
      "This command lets the Layman Legion remove a quote that shouldn't have been added.",
  },
  {
    id: 96,
    name: "!resetattempts",
  ...
  },
  {
    ...
    commandGroups: ["Stream"],
    description:
      "This command sets the game to whatever The Layman is playing!",
  },
  {
    id: 107,
    name: "!setlobby",
  ...
  },
  {
    ...
    commandGroups: ["Stream"],
    description:
      "This command sets the title to whatever the Layman Legion sets!",
  },
  {
    id: 115,
    name: "!settotaldeaths",
