...
function buildLeaderboard(
  ...
  return sorted.map((viewer, i) => {
    ...
    return {
      ...
      formattedValue:
        metric === "watchMinutes"
          ? formatWatchMinutes(value)
          : value.toLocaleString("en-US"),
    };
  });
}

export const WATCHTIME_LEADERBOARD: LeaderboardEntry[] =
  buildLeaderboard("watchMinutes");
